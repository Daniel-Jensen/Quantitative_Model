function [ys,params,check] = GK_2011_steadystate(ys,exo,M_,options_)

% function [ys,params,check] = GK_2011_steadystate(ys,exo,M_,options_)
% computes the steady state for the associated GK_2011.mod file using a numerical solver
%
% Inputs:
...
% Explicit reassignment so anonymous function closure can capture these
% (eval-created variables are not visible to MATLAB's anonymous function scoping)
betta     = M_.params(strcmp(M_.param_names, 'betta'));
psi       = M_.params(strcmp(M_.param_names, 'psi'));
h         = M_.params(strcmp(M_.param_names, 'h'));
gama      = M_.params(strcmp(M_.param_names, 'gama'));
alphaa    = M_.params(strcmp(M_.param_names, 'alphaa'));
theta     = M_.params(strcmp(M_.param_names, 'theta'));
delta_B   = M_.params(strcmp(M_.param_names, 'delta_B'));
omega     = M_.params(strcmp(M_.param_names, 'omega'));
epsilon   = M_.params(strcmp(M_.param_names, 'epsilon'));
Y_ss      = M_.params(strcmp(M_.param_names, 'Y_ss'));
delta_K_ss = M_.params(strcmp(M_.param_names, 'delta_K_ss'));
...
params = M_.params; % return calibrated parameter vector to Dynare
...
steady_st_values = zeros(1,NumberOfEndogenousVariables);
