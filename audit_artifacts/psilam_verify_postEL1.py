"""Re-verify psi_lambda_B against the 150bp target now that recovery_rate_D/F=0.30
(EL-1 resolution) changed EL_price from 0.1025 to 0.0717. Since psi_spread and
EL_price enter the bond FOC additively and EL_price fell, psi_lambda_B likely
needs to rise slightly to keep hitting the same 150bp target.
"""
import sys, copy
...
print(f"EL_price_D={float(ss['EL_price_D']):.6f}  psi_spread_base={psi_spread_base:.6f} at psi_lambda_B={psilam_base}")
