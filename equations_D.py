...
def bank_return_D(theta_D, rk_D, rdep_D, b_D_D, b_F_D, n_inter_D,
    ...
    # q_b·b is D-goods throughout, so rb_actual_F is already a D-good return for
    # the D-bank — no p-conversion (cf. bank_return_F, which holds D-good claims
    # on an F-good balance sheet and DOES convert).
