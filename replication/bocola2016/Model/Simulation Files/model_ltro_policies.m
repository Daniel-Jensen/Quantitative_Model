function [residuals,expectations,PREMIUM,RISK_comp,MULT_comp,prem1,policies] = model_ltro_policies(param,gamma,bounds,coll_points,TT,s,ss,EXP,V,expectations,prem,eps)
...
gam_5(:,j)   = ((log(exp(exp_1+exp_5))/TT)*(TT_exp.*EXP))';
...
exp_55           = log((psi*(exp_5./cc.^(-1)))./(1-mu));
