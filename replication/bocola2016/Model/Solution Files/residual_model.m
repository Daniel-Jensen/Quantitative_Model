function [residuals] = residual_model(param,gamma,bounds,coll_points,TT,s,ss,EXP,V,eps)
...
% evaluated at the collocation points), s (structure used to evaluate
% Chebyshev's polynomials for an arbitrary point in the state space), EXP 
% (matrix collecting coefficients for integral precomputation)
%
